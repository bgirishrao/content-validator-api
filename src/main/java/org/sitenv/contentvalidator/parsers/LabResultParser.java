...
import org.sitenv.contentvalidator.model.CCDALabResultObs;
import org.sitenv.contentvalidator.model.CCDALabResultOrg;
...
public class LabResultParser {
	...
	private static Logger log = LogManager.getLogger(LabResultParser.class.getName());
